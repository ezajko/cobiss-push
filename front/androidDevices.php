            ...
            <ul class="devices">
                ...
                if ($no_of_users > 0) {
                    ...
                    while ($row = mysql_fetch_array($users)) {
						...
						?>
                        <li>
                            <form id="<?php echo $device["tid"] ?>" name="" method="post" onsubmit="return sendPushNotification('<?php echo $device["tid"] ?>')">
                                ...
                                <div class="send_container">
									...
									<div class="cb"></div>
                                    <input type="hidden" name="regId" value="<?php echo $device["token"] ?>"/>
